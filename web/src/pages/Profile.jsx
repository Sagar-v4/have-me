...
export default function Profile() {
    ...
    const onNewEventFinish = async (e) => {
        ...
        try {
            await axios.put("https://api-have-me-v1gc.onrender.com/api/user/" + user._id, editUser)
    ...
    useEffect(() => {
        const fetchUser = async () => {
            const res = await axios.get("https://api-have-me-v1gc.onrender.com/api/user/" + user._id);
