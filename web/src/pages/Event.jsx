...
export default function Event() {
    ...
    const onNewEventFinish = async (e) => {
        ...
        try {
            await axios.post("https://api-have-me.onrender.com/api/event", newEvent)
    ...
    const onEditEventFinish = async (e) => {
        ...
        try {
            await axios.put("https://api-have-me.onrender.com/api/event/" + currEvent._id, EditEvent)
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            ...
            try {
                const res = await axios.get("https://api-have-me.onrender.com/api/event/" + user._id + "/user");
    ...
    useEffect(() => {
        const fetchPresences = async () => {
            try {
                const presence = await axios.get("https://api-have-me.onrender.com/api/presence/" + eventId + "/event");
                presence.data.map(r => {
    ...
    useEffect(() => {
        const fetchQR = async () => {
            try {
                const res = await axios.put("https://api-have-me.onrender.com/api/event/" + currEvent._id + "/qr", {user_id: user._id});
    ...
    useEffect(() => {
        const fetchAllUsers = async () => {
            try {
                const users = await axios.get("https://api-have-me.onrender.com/api/user/" + user._id + "/all");
    ...
    useEffect(() => {
        const setNewPresence = async () => {
            try {
                const p = await axios.post("https://api-have-me.onrender.com/api/presence", {
                    "event_id": eventId,
                    "user_id": newPresence,
                });
                p.data.map(r => {
    ...
    useEffect(() => {
        const setNewAssist = async () => {
            try {
                const p = await axios.post("https://api-have-me.onrender.com/api/assistant/", {
                    "user_id" : newAssist,
                    "event_id" : eventId,
                });
                p.data.map(r => {
    ...
    useEffect(() => {
        const fetchAssists = async () => {
            try {
                ...
                setPresences(presence.data);
                const assist = await axios.get("https://api-have-me.onrender.com/api/assistant/" + eventId + "/event");
                assist.data.map(r => {
                    r.name = r.user_id.name;
                    r.email = r.user_id.email;
                });
    ...
    useEffect(() => {
        const deleAssist = async () => {
            try {
                await axios.delete("https://api-have-me.onrender.com/api/assistant/" + delAssist);
                const assist = await axios.get("https://api-have-me.onrender.com/api/assistant/" + eventId + "/event");
                assist.data.map(r => {
                    r.name = r.user_id.name;
                    r.email = r.user_id.email;
    ...
    useEffect(() => {
        const updatePresence = async () => {
            try {
                await axios.put("https://api-have-me.onrender.com/api/presence/" + updPresence);
                const presence = await axios.get("https://api-have-me.onrender.com/api/presence/" + eventId + "/event");
                presence.data.map(r => {
                    r.name = r.user_id.name;
                    r.email = r.user_id.email;
