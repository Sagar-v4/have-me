...
export default function Scan({ navigation }) {
        ...
        return Alert.alert(
            ...
            [
                // The "Yes" button
                {
                    ...
                    onPress: async () => {
                        try {
                            const res = await axios.post("https://api-have-me-v1gc.onrender.com/api/presence/", {
                                "event_id": event._id,
                                "user_id": user,
                            });
    ...
    const findQR = async () => {
        ...
        setEvent(null);
        try {
            const res = await axios.get("https://api-have-me-v1gc.onrender.com/api/event/" + QR + "/qr");
            // res.data.map(r => {
            //     r.key = r._id;
